...
- (instancetype)initWithDataArr:(NSArray *)dataArr origin:(CGPoint)origin width:(CGFloat)width rowHeight:(CGFloat)rowHeight
{
    ...
    if (self) {
        ...
        [_tableView registerClass:[UITableViewCell class] forCellReuseIdentifier:@"PopViewLikeQQViewTableView"];
...
{
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"PopViewLikeQQViewTableView"];
...
{
    if([self.delegate respondsToSelector:@selector(PopViewLikeQQViewDelegateWithTableView:didSelectRowAtIndexPath:)]){
        [self.delegate PopViewLikeQQViewDelegateWithTableView:tableView didSelectRowAtIndexPath:indexPath];
    }
